...
<aside
  ...
  <div class="h-19.5">
    ...
    <a
      ...
      target="_blank">
      <img
        src="../../../img/core-img/favicon.ico"
        class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8"
        alt="main_logo" />
      <span
        class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Sound Entertainment</span>
    </a>
  </div>
    ...
    <ul class="flex flex-col pl-0 mb-0">
          ...
          <div
            ...
            <svg
              ...
              <path
                ...
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M5 3C4.44772 3 4 3.44772 4 4V20C4 20.5523 4.44772 21 5 21H19C19.5523 21 20 20.5523 20 20V8.82843C20 8.29799 19.7893 7.78929 19.4142 7.41421L15.5858 3.58579C15.2107 3.21071 14.702 3 14.1716 3H5ZM13 4V9H18V8.82843L14.1716 5H13Z"
                fill="currentColor" />
            </svg>
          </div>
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Music video</span>
        </a>
      </li>
      <li class="mt-0.5 w-full">
        <a
          class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
          href="../pages/addsong.php">
          <div
            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <svg
              width="20px"
              ...
              <path
                ...
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M9 17V5L19 3V15.18C18.37 14.74 17.56 14.5 16.67 14.5C14.72 14.5 13.14 16.07 13.14 18C13.14 19.93 14.72 21.5 16.67 21.5C18.62 21.5 20.2 19.93 20.2 18V7.11L11 8.78V17.18C10.37 16.74 9.56 16.5 8.67 16.5C6.72 16.5 5.14 18.07 5.14 20C5.14 21.93 6.72 23.5 8.67 23.5C10.62 23.5 12.2 21.93 12.2 20V5.6L9 6.2V17Z"
                fill="currentColor" />
            </svg>
          </div>
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Songs</span>
        </a>
      </li>
          ...
          <div
            ...
            <svg
              ...
              <path
                ...
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M16 13C18.21 13 20 14.79 20 17V18C20 18.55 19.55 19 19 19H9C8.45 19 8 18.55 8 18V17C8 14.79 9.79 13 12 13H16ZM6 19C5.45 19 5 18.55 5 18V17C5 15.9 5.9 15 7 15C7.35 15 7.69 15.07 8 15.21V15.2C7.37 15.94 7 16.92 7 18V19H6ZM12 12C10.34 12 9 10.66 9 9C9 7.34 10.34 6 12 6C13.66 6 15 7.34 15 9C15 10.66 13.66 12 12 12ZM7 14C5.34 14 4 12.66 4 11C4 9.34 5.34 8 7 8C8.66 8 10 9.34 10 11C10 12.66 8.66 14 7 14Z"
                fill="currentColor" />
            </svg>
          </div>
        ...
        <a
          ...
          <div
            ...
            <svg
              ...
              <path
                class="fill-slate-800"
                d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4ZM20 6L12 13L4 6V6.01L12 13.01L20 6.01V6Z"
                fill="currentColor" />
            </svg>
          </div>
      ...
      <li class="mt-0.5 w-full">
        <a
          ...
          <span
            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">user</span>
        </a>
      </li>
  ...
  <div class="mx-4 pt-10 pe-4">
    ...
    <div
      ...
      <div class="relative z-20 flex-auto w-full p-4 text-left text-white">
        <div
          class="flex items-center justify-center w-8 h-8 mb-4 text-center bg-center rounded-lg icon shadow-soft-2xl">
          <img
            src="../../../img/core-img/favicon.ico"
            class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8"
            alt="main_logo" />
        ...
        <div class="transition-all duration-200 ease-nav-brand">
          ...
          <p class="mt-0 mb-5 font-semibold leading-tight text-xs">
            Please check our docs
          </p>
          <a
            href="https://www.creative-tim.com/learning-lab/tailwind/html/quick-start/soft-ui-dashboard/"
            target="_blank"
            class="inline-block w-full px-8 py-2 mb-0 mt-5 font-bold text-center text-black uppercase transition-all ease-in bg-white border-0 border-white rounded-lg shadow-soft-md bg-150 leading-pro text-xs hover:shadow-soft-2xl hover:scale-102">Documentation</a>
        </div>
      </div>
    </div>
  </div>
